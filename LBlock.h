...
const unsigned short S[10][16]={{14,9,15,0,13,4,10,11,1,2,8,3,7,6,12,5},{4,11,14,9,15,13,0,10,7,12,5,6,2,8,1,3},{1,14,7,12,15,13,0,6,11,5,9,3,2,4,8,10},
				...
				{11,9,4,14,0,15,10,13,6,12,5,7,3,8,1,2},{13,10,15,0,14,4,9,11,2,1,8,3,7,5,12,6},{8,7,14,5,15,13,0,6,11,12,9,10,2,4,1,3}, // The S-box values as presented in the report
				{11,5,15,0,7,2,9,13,4,8,1,12,14,10,3,6}};
const unsigned short P[8]={1,3,0,2,5,7,4,6}; //this array is used for the diffusion function P. It signifies the subscripts of the Z elements starting from LSB.
